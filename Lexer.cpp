...
int main()
{
    ...
    // File streams
    ifstream input("tester5.txt");
    ofstream output("parse5.txt");
    ...
    while(getline(input,s))
    {
        ...
        {
            //Comment removal - skipping characters
                    ...
                    while(breaker==1)
                    {
                        switch(state)
                        {
                            ...
                            case 2:
                                ...
                                else if(temp==5 || prev_token=="+=" || prev_token=="-=" || prev_token=="*=" || prev_token=="==" || prev_token=="/=" || prev_token=="<=" || prev_token=="!=" || prev_token==">=" || prev_token=="%=" || prev_token=="(" || prev_token=="[" || prev_token=="return")
                                {
